...
/khklklhjl
                ...
                <a href="#" class="input-group-addon btn btn-danger fileinput-exists" data-dismiss="fileinput">Remova a
                    foto</a>
            </div>
        </div>
    </div>
        ...
        <div class="fileinput-new row" data-provides="fileinput">
            <div class="col-sm-12 col-lg-10 col-xl-10 input-group">
                ...
                <span class="input-group-addon btn btn-primary btn-file">
                    ...
                    'class' => $errors->has('base64_image3') ? 'custom-file-input form-control is-invalid' :
        ...
        <div class="fileinput-new row" data-provides="fileinput">
            <div class="col-sm-12 col-lg-10 col-xl-10 input-group">
                ...
                <span class="input-group-addon btn btn-primary btn-file">
                    ...
                    'class' => $errors->has('base64_image4') ? 'custom-file-input form-control is-invalid' :
                    'custom-file-input form-control',
                    'id' => 'base64_image4'
                    ]) !!}
                    <span class="invalid-feedback">
        ...
        <div class="fileinput-new row" data-provides="fileinput">
            <div class="col-sm-12 col-lg-10 col-xl-10 input-group">
                ...
                <span class="input-group-addon btn btn-primary btn-file">
                    ...
                    'class' => $errors->has('base64_image5') ? 'custom-file-input form-control is-invalid' :
                    'custom-file-input form-control',
                    'id' => 'base64_image5'
                    ]) !!}
                    <span class="invalid-feedback">
        ...
        <div class="fileinput-new row" data-provides="fileinput">
            <div class="col-sm-12 col-lg-10 col-xl-10 input-group">
                ...
                <span class="input-group-addon btn btn-primary btn-file">
                    ...
                    'class' => $errors->has('base64_image6') ? 'custom-file-input form-control is-invalid' :
                    'custom-file-input form-control',
                    'id' => 'base64_image2'
                    ]) !!}
                    <span class="invalid-feedback">
        ...
        <div class="fileinput-new row" data-provides="fileinput">
            <div class="col-sm-12 col-lg-10 col-xl-10 input-group">
                ...
                <span class="input-group-addon btn btn-primary btn-file">
                    ...
                    'class' => $errors->has('base64_image7') ? 'custom-file-input form-control is-invalid' :
                    'custom-file-input form-control',
                    'id' => 'base64_image2'
                    ]) !!}
                    <span class="invalid-feedback">
        ...
        <div class="fileinput-new row" data-provides="fileinput">
            <div class="col-sm-12 col-lg-10 col-xl-10 input-group">
                ...
                <span class="input-group-addon btn btn-primary btn-file">
                    ...
                    'class' => $errors->has('base64_image8') ? 'custom-file-input form-control is-invalid' :
                    'custom-file-input form-control',
                    'id' => 'base64_image8'
                    ]) !!}
                    <span class="invalid-feedback">
        ...
        <div class="fileinput-new row" data-provides="fileinput">
            <div class="col-sm-12 col-lg-10 col-xl-10 input-group">
                ...
                <span class="input-group-addon btn btn-primary btn-file">
                    ...
                    'class' => $errors->has('base64_image9') ? 'custom-file-input form-control is-invalid' :
                    'custom-file-input form-control',
                    'id' => 'base64_image9'
                    ]) !!}
                    <span class="invalid-feedback">
        ...
        <div class="fileinput-new row" data-provides="fileinput">
            <div class="col-sm-12 col-lg-10 col-xl-10 input-group">
                ...
                <span class="input-group-addon btn btn-primary btn-file">
                    ...
                    'class' => $errors->has('base64_image10') ? 'custom-file-input form-control is-invalid' :
                    'custom-file-input form-control',
                    'id' => 'base64_image10'
                    ]) !!}
                    <span class="invalid-feedback">
    ...
    <div class="card-body py-5" style="margin-top:-6%;">
        {!! Form::label('base64_image11', 'Décima primeira foto (tamanho sugerido 800x533)', null, ['class' =>
        'control-label']) !!}
        <div class="fileinput-new row" data-provides="fileinput">
            <div class="col-sm-12 col-lg-10 col-xl-10 input-group">
                ...
                <span class="input-group-addon btn btn-primary btn-file">
                    ...
                    'class' => $errors->has('base64_image12') ? 'custom-file-input form-control is-invalid' :
                    'custom-file-input form-control',
                    'id' => 'base64_image12'
                    ]) !!}
                    <span class="invalid-feedback">
    ...
    <div class="card-body py-5" style="margin-top:-6%;">
        {!! Form::label('base64_image13', 'Décima terceira foto (tamanho sugerido 800x533)', null, ['class' =>
        'control-label']) !!}
        <div class="fileinput-new row" data-provides="fileinput">
            <div class="col-sm-12 col-lg-10 col-xl-10 input-group">
                ...
                <span class="input-group-addon btn btn-primary btn-file">
                    ...
                    'class' => $errors->has('base64_image15') ? 'custom-file-input form-control is-invalid' :
                    'custom-file-input form-control',
                    'id' => 'base64_image13'
                    ]) !!}
                    <span class="invalid-feedback">
    ...
    <div class="card-body py-5" style="margin-top:-6%;">
        {!! Form::label('base64_image14', 'Décima quarta foto (tamanho sugerido 800x533)', null, ['class' =>
        'control-label']) !!}
        <div class="fileinput-new row" data-provides="fileinput">
            <div class="col-sm-12 col-lg-10 col-xl-10 input-group">
                ...
                <span class="input-group-addon btn btn-primary btn-file">
                    ...
                    'class' => $errors->has('base64_image14') ? 'custom-file-input form-control is-invalid' :
                    'custom-file-input form-control',
                    'id' => 'base64_image14'
                    ]) !!}
                    <span class="invalid-feedback">
    ...
    <div class="card-body py-5 " style="margin-top:-6%;">
        {!! Form::label('base64_image15', 'Décima quinta foto (tamanho sugerido 800x533)', null, ['class' =>
        'control-label']) !!}
        <div class="fileinput-new row" data-provides="fileinput">
            <div class="col-sm-12 col-lg-10 col-xl-10 input-group">
    ...
    <div class="card text-dark bg-secondary border-dark shadow-lg mb-3">
        ...
        <div class="card-body py-5 ">
            ...
            <div class="form-group row">
                ...
                <div class="card-body py-5 ">
                    {!! Form::label('base64_promocao1', 'Imagem da promoção 2 (tamanho sugerido 500x400)', null,
                    ['class' => 'control-label']) !!}
                    <div class="fileinput-new row" data-provides="fileinput">
                        <div class="col-sm-12 col-lg-10 col-xl-10 input-group">
